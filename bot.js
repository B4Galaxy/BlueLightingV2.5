...
bot.on("ready", function() {
  bot.user.setGame(`-help | v2.5 | ${bot.guilds.size} servers! WOW`,'https://twitch.tv/123silly');
...
bot.on("message", function(message) {
    ...
    switch (args[0].toLowerCase()) {
        case "chelp":
            ...
            .setFooter("Made by B4Galaxy#3057 | BluelightingV2.5.5.5")
            .setColor(0x1ab517)
           ...
           .setFooter("Made by B4Galaxy#3057 | BluelightingV2.5.5.5.5")
           .setColor(0xad0505)
...
break;
         case "hello":
            ...
            case "good":
               ...
               case "ip":
                  message.delete("ip")
                  message.channel.sendMessage("```The Ip Is mcnetwork.mymc.uk Current In Progress [Beta] Also 1.9-1.12```");
                  break;
               case "bad":
                   message.delete("bad")
               ...
               case "invite":
                   ...
                   message.channel.sendMessage("You can invite me here: https://discordapp.com/oauth2/authorize?client_id=389489277358047265&scope=bot&permissions=2146958591&response_type=code");
                  break;
                  case "kys":
                      message.delete("kys")
                     ...
                     case "magik":
                        ...
                        break;
                        case "3girl":
                            message.delete("3girl")
                            message.channel.sendMessage("This bot was made for @123silly and @Telk(<3).");
                            break;
                                  case "ping":
                                         message.delete("ping")
...
break;
case "support":
message.channel.sendMessage('Support Discord Server: Soon')
break;
case "commands":
message.delete("commands")
message.channel.sendMessage("Sorry about that! The command is -chelp! :cry:")
break;
case "help":
message.delete("help")
console.log(`<@${message.author.id}> Wanted -help`);
message.channel.sendMessage("Hi There. I am **BluelightingV2.5.5.5.5.5**. Coded in Discord.JS and Atom.io by B4Galaxy#3057 Type -chelp for commands!");
break;
case "donate":
message.channel.sendMessage("donate at our server with /buy");
break;
case "userinfo":
message.delete("userinfo")
console.log(`<@${message.author.id}> is using userinfo!`);
var ui = new Discord.RichEmbed()
.setTitle(`--{ LightBlue User Info }--`)
...
.setFooter(`Made by B4Galaxy#3057 | BluelightingV2.5.5.5.5.5`)
.setColor(0xf4ad42)
...
.setTitle(`--{ LightBlue Server Info }`)
...
break;
case "tyler":
message.delete("tyler")
message.channel.sendMessage("He is a very good coder. I like him :wink:");
break;
case "cutecat":
...
bot.login(process.env.Mzg5NDg5Mjc3MzU4MDQ3MjY1.DRSZ7Q.EOCHuFln8hB4yj2PxgW5bDCJW3o);
